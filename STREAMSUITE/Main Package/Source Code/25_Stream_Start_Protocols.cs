...
public class CPHInline
{
    ...
    public bool Execute()
    {
        ...
        CPH.TwitchSendAndPinMessage($"👋 Welcome to @{userNorm}'s stream! This channel uses Stream Suite's attendance system instead of Twitch's viewer count, so please send a chat message or use the 'Attendance Check!' redeem to be counted as an attendee! Thanks for stopping by! 💙");
