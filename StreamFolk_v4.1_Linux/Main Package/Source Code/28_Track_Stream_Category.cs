...
This action helps StreamFolk identify which category and stream title were
...
public class CPHInline
{
    ...
    public bool Execute()
    {
        ...
        if (!string.IsNullOrWhiteSpace(category))
        {
            ...
            CPH.LogInfo("StreamFolk Category Tracker: Current category saved as '" + category + "'.");
        }
        else
        {
            CPH.LogWarn("StreamFolk Category Tracker: No category argument was supplied. The previously saved category was left unchanged.");
        }
