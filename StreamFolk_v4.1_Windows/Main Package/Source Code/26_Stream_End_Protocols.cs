...
public class CPHInline
{
    ...
    private FinalSummary BuildFinalSummary(AttendanceSummary attendance)
    {
        ...
        string category = CPH.GetGlobalVar<string>(CurrentCategoryKey, true);
...
────────────────────────────────";
    ...
    private void SendSmsSummary(string smsBody)
    {
        ...
        {
            CPH.LogWarn("StreamFolk End: SMS summary is enabled, but one or more email-to-SMS placeholders are not configured.");
            return;
        }
